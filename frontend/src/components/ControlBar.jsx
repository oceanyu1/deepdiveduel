...
export default function ControlBar({ 
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-slate-800 border border-slate-700 rounded-lg shadow-lg">
      ...
      <div className="flex justify-center mt-4">
        {!isRunning ? (
          <button 
            onClick={onStart}
            className="flex items-center justify-center px-8 py-3 bg-slate-700 text-white font-bold rounded-lg shadow-md hover:bg-slate-600 transition-colors disabled:bg-slate-600 disabled:cursor-not-allowed"
